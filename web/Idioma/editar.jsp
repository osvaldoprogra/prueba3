            ...
            <div class="row">
                <div class="panel panel-primary">
                    ...
                    <% 
                        ...
                        Conex con=new Conex();
                        con.setConsulta("select * from idiomas where idioma_id='"+id+"'");
                    %>
                    <div class="panel-body">
                        <% while(con.getResultado().next()){  %>
                        
                        <form method="POST" action="../ServletIdioma?editar=si">
                            
                            IdIdioma:<input type="text" readonly="true" value='<% out.println(""+con.getResultado().getString("idioma_id")); %>' name="id"><br>
                            <div class="form-group">
