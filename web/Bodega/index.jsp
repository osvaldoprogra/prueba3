            ...
            <div class="row">
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        <a href="crear.jsp" class="btn btn-primary">Bodega Nueva</a>
                                ...
                                <%                                     Conex con = new Conex();
                                    if (request.getParameter("buscarNombre") != null) {
                                        if (request.getParameter("buscarNombre").isEmpty()) {
                                            con.setConsulta("select bodegas.bodega_id,bodegas.nombre,sucursales.nombre as suc,usuarios.user from sucursales,usuarios,bodegas where bodegas.sucursal_id=sucursales.sucursal_id and bodegas.creado_por=usuarios.usuario_id and  bodegas.estado='activo'");
                                        } else {
                                            String nombre = request.getParameter("buscarNombre");
                                            con.setConsulta("select  bodegas.bodega_id,bodegas.nombre,sucursales.nombre as suc,usuarios.user from sucursales,usuarios,bodegas where bodegas.nombre like '%" + nombre + "%' and bodegas.sucursal_id=sucursales.sucursal_id and bodegas.creado_por=usuarios.usuario_id and  bodegas.estado='activo'");
                                    ...
                                    while (con.getResultado().next()) {
                                        out.println("<tr>");
                                        out.println("<td>" + con.getResultado().getString("bodega_id") + "</td>");
                                        out.println("<td>" + con.getResultado().getString("nombre") + "</td>");
                                        out.println("<td>" + con.getResultado().getString("suc") + "</td>");
                                        out.println("<td>" + con.getResultado().getString("user") + "</td>");

                                        out.println("<td>" + "<a href='../ServletBodega?eliminar=" + con.getResultado().getString("bodega_id") + "' class='btn btn-danger'>Eliminar</a>" + "</td>");
                                        out.println("<td>" + "<a href='editar.jsp?editar=" + con.getResultado().getString("bodega_id") + "' class='btn btn-primary'>Editar</a>" + "</td>");
