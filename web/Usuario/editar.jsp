                    ...
                    <div class="panel-body">
                        ...
                        <form method="POST" action="../ServletUsuario?editar=si">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="user" value='<% out.println(""+con.getResultado().getString("user")); %>' id="nombre" placeholder="Ingresar Nombre">
                            </div>
                             <div class="form-group">
                                <label for="nombre">Password</label>
                                <input type="password" class="form-control" name="pass" value='<% out.println(""+con.getResultado().getString("clave")); %>' id="nombre" placeholder="Ingresar Password">
                            </div>
