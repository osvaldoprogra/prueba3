# prueba3
```
MariaDB [(none)]> create database inacap;
Query OK, 1 row affected (0.03 sec)

MariaDB [inacap]> create table usuarios(usuario_id int(10) primary key not null auto_increment,
    -> user varchar(50),
    -> clave varchar (25),
    -> estado varchar(6));
Query OK, 0 rows affected (0.39 sec)

MariaDB [inacap]> create table autores(autor_id int(10) primary key not null auto_increment,
    -> nombre varchar(50),
    -> estado varchar(6));
Query OK, 0 rows affected (0.30 sec)

MariaDB [inacap]> create table idiomas(idioma_id int(10) primary key not null auto_increment,
    -> nombre varchar(25),
    -> estado varchar(6));
Query OK, 0 rows affected (0.27 sec)


MariaDB [inacap]> create table libros (libro_id int (10) primary key not null auto_increment,
    -> isbn varchar(30),
    -> nombre varchar(50),
