            ...
            <div class="row">
                <div class="panel panel-primary">
                    ...
                    <% 
                        ...
                        Conex con=new Conex();
                        con.setConsulta("select * from autores where autor_id='"+id+"'");
                    %>
                    <div class="panel-body">
                        <% while(con.getResultado().next()){  %>
                        
                        <form method="POST" action="../ServletAutor?editar=si">
                            
                            IdAutor:<input type="text" readonly="true" value='<% out.println(""+con.getResultado().getString("autor_id")); %>' name="id"><br><br>
                            <div class="form-group">
