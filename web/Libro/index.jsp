                                ...
                                <%                                    Conex con = new Conex();
                                    if (request.getParameter("buscarNombre") != null) {
                                        if (request.getParameter("buscarNombre").isEmpty()) {
                                            con.setConsulta("select autores.autor_id as id,autores.nombre as autor,idiomas.nombre as idioma,libros.libro_id,libros.isbn,libros.bodega_id,libros.nombre,libros.creado_por,libros.cantidad_paginas,usuarios.user,bodegas.nombre as bo from bodegas,libros,usuarios,idiomas,autores where libros.bodega_id=bodegas.bodega_id and libros.autor_id=autores.autor_id and libros.idioma_id=idiomas.idioma_id and usuarios.usuario_id=libros.creado_por and libros.estado='activo'");

                                        } else {
                                            String nombre = request.getParameter("buscarNombre");
                                            con.setConsulta("select autores.autor_id as id,autores.nombre as autor,idiomas.nombre as idioma,libros.libro_id,libros.isbn,libros.nombre,libros.bodega_id,libros.creado_por,libros.cantidad_paginas,usuarios.user from libros,usuarios,idiomas,autores where libros.nombre like '%" + nombre + "%' and libros.autor_id=autores.autor_id and libros.idioma_id=idiomas.idioma_id and usuarios.usuario_id=libros.creado_por and libros.estado='activo'");
                                    ...
                                    while (con.getResultado().next()) {
                                        ...
                                        out.println("<td>" + con.getResultado().getString("bo") + "</td>");
