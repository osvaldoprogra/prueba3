            ...
            <div class="row">
                <div class="panel panel-primary">
                    <div class="panel-heading">
                        <h3 class="panel-title">Listar Idioma</h3>
                    </div>
                ...
                if (request.getParameter("buscarNombre") != null) {
                    if (request.getParameter("buscarNombre").isEmpty()) {
                        ...
                        con.setConsulta("select * from Idiomas where nombre like '%"+nombre+"%' and estado='activo'");
                    }
                }else{
                    con.setConsulta("select * from Idiomas where estado='activo'");
                }
                                   while(con.getResultado().next()){
                                    out.println("<tr>");
                                       out.println("<td>"+con.getResultado().getString("idioma_id")+"</td>");
                                       out.println("<td>"+con.getResultado().getString("nombre")+"</td>");
                                      
                                      out.println("<td>"+"<a href='../ServletIdioma?eliminar="+con.getResultado().getString("idioma_id")+"' class='btn btn-danger'>Eliminar</a>"+"</td>");
                                       out.println("<td>"+"<a href='editar.jsp?editar="+con.getResultado().getString("idioma_id")+"' class='btn btn-primary'>Editar</a>"+"</td>");
